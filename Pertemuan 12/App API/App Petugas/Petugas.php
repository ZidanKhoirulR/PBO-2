...
class Petugas 
{
    ...
    {
        $query = "INSERT INTO $this->table (`kode_petugas`,`nama_petugas`,`no_telp`,`alamat`) VALUES ('$this->kode_petugas','$this->nama_petugas','$this->no_telp','$this->alamat')";
        $this->db->query($query);
        return $this->db->insert_id();
    }
    public function update(int $id): int
    {
        $query = "UPDATE $this->table SET kode_petugas = '$this->kode_petugas', nama_petugas = '$this->nama_petugas', no_telp = '$this->no_telp', alamat = '$this->alamat' 
        WHERE id_petugas = $id";
        $this->db->query($query);
