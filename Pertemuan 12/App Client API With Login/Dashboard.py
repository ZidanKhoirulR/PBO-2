...
class Dashboard:
    ...
    def aturKomponen(self):
        ...
        mainFrame.configure(bg="dark blue")
    ...
    def menuAnggota(self):
        ...
        anggota_menu.add_command(
            label='Data Anggota ', command= lambda: self.new_window("Menu Data Anggota", FrmAnggota)
        )
        anggota_menu.add_command(
...
if __name__ == '__main__':
    root = tk.Tk()
    my_str = tk.StringVar()
    aplikasi = Dashboard(root, "Dashboard Apilikasi Perpustakaan")
    root.mainloop() 