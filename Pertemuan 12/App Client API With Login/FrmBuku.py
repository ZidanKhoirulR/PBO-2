...
class FrmBuku:
    ...
    def aturKomponen(self):
        ...
        # define columns
        columns = ('id_buku','kode_buku','judul_buku','penulis_buku','penerbit_buku','tahun_terbit','stok')
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["id_buku"],d["kode_buku"],d["judul_buku"],d["penulis_buku"],d["penerbit_buku"],d["tahun_terbit"],d["stok"]))
    ...
    def TampilkanData(self, event=None):
        ...
        self.txtTahun_terbit.delete(0,END)
        self.txtTahun_terbit.insert(END,obj.penerbit_buku)
        self.txtStok.delete(0,END)
