...
class FrmPeminjaman:
    ...
    def aturKomponen(self):
        ...
        # define columns
        columns = ('id_peminjaman','kode_peminjaman','tanggal_pinjam','tanggal_kembali','id_anggota','id_buku','id_petugas')
        ...
        self.tree.column('kode_peminjaman', width="30")
        self.tree.heading('tanggal_pinjam', text='TANGGAL_PINJAM')
        self.tree.column('tanggal_pinjam', width="30")
        self.tree.heading('tanggal_kembali', text='TANGGAL_KEMBALI')
        self.tree.column('tanggal_kembali', width="30")
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["id_peminjaman"],d["kode_peminjaman"],d["tanggal_pinjam"],d["tanggal_kembali"],d["id_anggota"],d["id_buku"],d["id_petugas"]))
