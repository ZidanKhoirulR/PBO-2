...
class FrmPengembalian:
    ...
    def aturKomponen(self):
        ...
        self.txtKode_pengembalian.bind('<Return>',self.onCari)
        #Textbox
        ...
        # define columns
        columns = ('id_pengembalian','kode_pengembalian','tanggal_pengembalian','denda','id_buku','id_anggota','id_petugas')
        ...
        self.tree.column('kode_pengembalian', width="30")
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["id_pengembalian"],d["kode_pengembalian"],d["tanggal_pengembalian"],d["denda"],d["id_buku"],d["id_anggota"],d["id_petugas"]))
